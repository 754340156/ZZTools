...
@interface ZZMBProgressManager ()<UIGestureRecognizerDelegate>
{
    UITapGestureRecognizer *tap;
}
@end
@implementation ZZMBProgressManager
UIView *bottomView;
static ZZMBProgressManager *hudManager = nil;
UIView *hudAddedView;
