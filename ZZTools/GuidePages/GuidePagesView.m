...
-(void)loadPageView
{
    ...
    scrollView.contentSize = CGSizeMake((_imageArray.count + 1)*kScreenW, kScreenH);
    ...
    UIPageControl *pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(kScreenW/2, kScreenH - 60, 0, 40)];
...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if (scrollView.contentOffset.x == (_imageArray.count) *kScreenW) {
        [self removeFromSuperview];
    }
}
