...
//  DiDiBeauty
//
//  Created by zhaozhe on 17/3/3.
//  Copyright © 2017年 zhaozhe. All rights reserved.
//

#import "ZZActivityView.h"

static ZZActivityView *activiyView;

@interface ZZActivityView ()
...
+ (void)showActiviTy
{
    ...
    dispatch_once(&onceToken, ^{
        if (activiyView == nil) {
            ...
            activiyView = [[ZZActivityView alloc] initWithFrame:rect];
